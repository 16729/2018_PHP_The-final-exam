...
<body>
	...
	if (isset($_SESSION["user"])){
		...
		echo "<script type='text/javascript'>alert('未登录用户不允许访问欢迎页，请重新登录...');history.back();
	</script>";
	}
?>			
	<div id="container">
		<header>
			<div class="logo">
				<marquee loop="-1" scrollamount="3"style="color:gray">欢迎<?=$_SESSION["user"]?>管理员用户来到我的博客~</marquee>
			</div>
			<div class="menu">
				<ul>
					...
					<li><a href="#">联系</a></li> 
					<li><a href="#">订阅</a></li> 
					<li><a href="glshydelall_root.php">留言</a></li> 
				</ul>
			</div>
		</header>
		<div class="content">
			<div class="left">
				<div class="section">
					...
					<form method="post" action="index_root.php"class="bd">
